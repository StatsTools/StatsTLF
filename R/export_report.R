...
#' export_report('teste')
#' }
export_report <- function(package, template_name = "template_PT-BR.docx", supp = FALSE, add_toc = TRUE) {
 ...
 return(export_report_method(x = package, template_name = template_name, supp = supp, add_toc = add_toc))
}
